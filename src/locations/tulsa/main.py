...
def run_tulsa_pipeline(live_pump_price: float = None, use_llm_api: bool = False, model_type: str = "ridge"):
    ...
    print("\n[Step 3/6] Engineering Tulsa Crack Spread & Fusing Decayed Event Memory (Multi-Horizon 1D-5D)...")
    ...
    print("\n" + "=" * 65)
    print("         TULSA REGIONAL MODEL EVALUATION & METRICS SUMMARY (5-DAY)")
    print("=" * 65)
    ...
    for h in [1, 2, 3, 4, 5]:
        ...
        backfill_new_region_history(
            ...
            quant_baseline_prices=hist_tulsa_quant
        )
