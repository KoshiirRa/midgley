"""
National Wholesale RBOB Futures Forecast Model Pipeline (src/locations/national/main.py)
...
def run_national_pipeline(use_llm_api: bool = False, model_type: str = "ridge"):
    print("=" * 80)
    print("  LLM-AUGMENTED UNLEADED GAS PRICE PREDICTION PIPELINE (NATIONAL)")
    print("=" * 80)
...
if __name__ == "__main__":
    ...
    run_national_pipeline(use_llm_api=use_api, model_type="ridge")
