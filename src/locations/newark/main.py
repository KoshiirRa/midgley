...
def run_newark_pipeline(live_pump_price: float = None, use_llm_api: bool = False, model_type: str = "ridge"):
    ...
    for h in [1, 2, 3, 4, 5]:
        ...
        hist_newark_pred = hist_newark_base * (1.0 + pred_ret_hybrid)
        hist_newark_quant = hist_newark_base * (1.0 + pred_ret_quant)
        ...
        log_predictions(today_df, region="Newark_DE", model_version=newark_version, run_type="LIVE_PROSPECTIVE", forecast_horizon_days=h, is_retroactive_backtest=False)
