...
(notebooks/newark_gas_price_llm_forecasting.ipynb)
"""

import json
import os

notebook_path = os.path.join("notebooks", "newark_gas_price_llm_forecasting.ipynb")
...
print(f"Successfully generated Newark notebook at {notebook_path}")
