...
**Log Timestamp:** `2026-09-01 14:27:01`  
...
- **National Wholesale**: $P = \$3.437 + (+\$0.000) = \$3.118\text{/gal}$ (Delta: +\$0.000/gal, 0.00\%)
- **Tulsa, OK Retail**: $P = \$3.701 + (+\$0.155) = \$3.602\text{/gal}$ (Delta: +\$0.155/gal, +4.18\%)
- **Newark, DE Retail**: $P = \$3.940 + (+\$0.142) = \$3.796\text{/gal}$ (Delta: +\$0.142/gal, +3.60\%)
- **Cincinnati, OH/KY**: $P = \$3.821 + (+\$0.146) = \$3.681\text{/gal}$ (Delta: +\$0.146/gal, +3.82\%)
- **Greenville, NC Retail**: $P = \$3.599 + (+\$0.152) = \$3.446\text{/gal}$ (Delta: +\$0.152/gal, +4.23\%)
- **Charlotte, NC Retail**: $P = \$3.791 + (+\$0.147) = \$3.648\text{/gal}$ (Delta: +\$0.147/gal, +3.87\%)
- **Oakland, CA Retail**: $P = \$5.703 + (+\$0.301) = \$5.513\text{/gal}$ (Delta: +\$0.301/gal, +5.28\%) *(includes CA statutory CARB excise, Cap-and-Trade & LCFS fee overhead of $0.953/gal)*
- **SF Bay Area Region**: $P = \$5.703 + (+\$0.201) = \$5.513\text{/gal}$ (Delta: +\$0.201/gal, +3.53\%) *(includes CA statutory CARB excise, Cap-and-Trade & LCFS fee overhead of $0.953/gal)*
...
The base commodity forecast was calibrated across all 8 modeled metro locales for this run:
  • National Wholesale: $3.118/gal ($0.000/gal, 0.00%)
  • Tulsa, OK Retail: $3.602/gal (+$0.155/gal, +4.18%)
  • Newark, DE Retail: $3.796/gal (+$0.142/gal, +3.60%)
  • Cincinnati, OH/KY: $3.681/gal (+$0.146/gal, +3.82%)
  • Greenville, NC Retail: $3.446/gal (+$0.152/gal, +4.23%)
  • Charlotte, NC Retail: $3.648/gal (+$0.147/gal, +3.87%)
  • Oakland, CA Retail: $5.513/gal (+$0.301/gal, +5.28%)
  • SF Bay Area Region: $5.513/gal (+$0.201/gal, +3.53%)

Largest upward shift for this run: Oakland, CA Retail at $5.513/gal (+0.301/gal). Largest downward shift for this run: National Wholesale at $3.118/gal (+0.000/gal). California locations (Oakland & SF Bay Area) incorporate statutory $0.953/gal CARB excise, Cap-and-Trade, and LCFS fee overhead on top of the base commodity calibration.

### Forecast Uncertainty & Counterfactual Catalysts
FORECAST UNCERTAINTY & CATALYST SCENARIOS FOR THIS RUN:

Evaluated tail-risk catalysts specific to execution [2026-09-01 14:27:01]:
...
---
*Report generated automatically by Midgley Dashboard Generator Engine at 2026-09-01 14:27:01.*
