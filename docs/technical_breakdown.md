...
**Log Timestamp:** `2026-09-01 07:02:45`  
...
- **National Wholesale**: $P = \$3.437 + (+\$0.000) = \$3.175\text{/gal}$ (Delta: +\$0.000/gal, 0.00\%)
...
The base commodity forecast was calibrated across all 8 modeled metro locales for this run:
  • National Wholesale: $3.175/gal ($0.000/gal, 0.00%)
...
Largest upward shift for this run: Oakland, CA Retail at $5.522/gal (+0.298/gal). Largest downward shift for this run: National Wholesale at $3.175/gal (+0.000/gal). California locations (Oakland & SF Bay Area) incorporate statutory $0.953/gal CARB excise, Cap-and-Trade, and LCFS fee overhead on top of the base commodity calibration.

### Forecast Uncertainty & Counterfactual Catalysts
FORECAST UNCERTAINTY & CATALYST SCENARIOS FOR THIS RUN:

Evaluated tail-risk catalysts specific to execution [2026-09-01 07:02:45]:
...
---
*Report generated automatically by Midgley Dashboard Generator Engine at 2026-09-01 07:02:45.*
