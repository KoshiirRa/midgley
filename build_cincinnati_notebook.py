...
(notebooks/cincinnati_gas_price_llm_forecasting.ipynb)
"""

import json
import os

notebook_path = os.path.join("notebooks", "cincinnati_gas_price_llm_forecasting.ipynb")
...
print(f"Successfully generated Cincinnati notebook at {notebook_path}")
