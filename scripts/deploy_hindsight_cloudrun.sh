...
gcloud run deploy "$SERVICE_NAME" \
    ...
    --cpu 2 \
    --timeout 300 \
    --set-env-vars HINDSIGHT_API_PORT="8888",HINDSIGHT_API_DATABASE_URL="$SUPABASE_DATABASE_URL",DATABASE_URL="$SUPABASE_DATABASE_URL",HINDSIGHT_API_RUN_MIGRATIONS_ON_STARTUP="true",HINDSIGHT_API_SKIP_LLM_VERIFICATION="true",HINDSIGHT_API_LLM_PROVIDER="gemini",HINDSIGHT_API_LLM_MODEL="$HINDSIGHT_LLM_MODEL",HINDSIGHT_API_LLM_API_KEY="$GEMINI_API_KEY",HINDSIGHT_API_DB_POOL_MAX="10"
