"""
Script to programmatically generate the Jupyter Notebook `notebooks/gas_price_llm_forecasting.ipynb`
following notebook-guidance and ml-best-practices.
"""

import json
import os

notebook_path = os.path.join("notebooks", "gas_price_llm_forecasting.ipynb")
