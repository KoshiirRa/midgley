...
**Log Timestamp:** `2026-08-29 17:13:28`  
...
- **National Wholesale**: $P = \$3.384 + (+\$0.000) = \$3.237\text{/gal}$ (Delta: +\$0.000/gal, 0.00\%)
- **Tulsa, OK Retail**: $P = \$3.890 + (+\$0.014) = \$3.729\text{/gal}$ (Delta: +\$0.014/gal, +0.35\%)
...
The base commodity forecast was calibrated across all 8 modeled metro locales for this run:
  • National Wholesale: $3.237/gal ($0.000/gal, 0.00%)
  • Tulsa, OK Retail: $3.729/gal (+$0.014/gal, +0.35%)
...
Largest upward shift for this run: Greenville, NC Retail at $3.137/gal (+0.040/gal). Largest downward shift for this run: SF Bay Area Region at $4.869/gal (-0.509/gal). California locations (Oakland & SF Bay Area) incorporate statutory $0.953/gal CARB excise, Cap-and-Trade, and LCFS fee overhead on top of the base commodity calibration.

### Forecast Uncertainty & Counterfactual Catalysts
FORECAST UNCERTAINTY & CATALYST SCENARIOS FOR THIS RUN:

Evaluated tail-risk catalysts specific to execution [2026-08-29 17:13:28]:
...
---
*Report generated automatically by Midgley Dashboard Generator Engine at 2026-08-29 17:13:28.*
