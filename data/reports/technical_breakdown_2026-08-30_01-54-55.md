...
**Log Timestamp:** `2026-08-30 01:54:52`  
...
- **Greenville, NC Retail**: $P = \$3.250 + (+\$0.146) = \$3.132\text{/gal}$ (Delta: +\$0.146/gal, +4.48\%)
...
The base commodity forecast was calibrated across all 8 modeled metro locales for this run:
  ...
  • Greenville, NC Retail: $3.132/gal (+$0.146/gal, +4.48%)
...
Largest upward shift for this run: Greenville, NC Retail at $3.132/gal (+0.146/gal). Largest downward shift for this run: SF Bay Area Region at $4.871/gal (-0.508/gal). California locations (Oakland & SF Bay Area) incorporate statutory $0.953/gal CARB excise, Cap-and-Trade, and LCFS fee overhead on top of the base commodity calibration.

### Forecast Uncertainty & Counterfactual Catalysts
FORECAST UNCERTAINTY & CATALYST SCENARIOS FOR THIS RUN:

Evaluated tail-risk catalysts specific to execution [2026-08-30 01:54:52]:
...
---
*Report generated automatically by Midgley Dashboard Generator Engine at 2026-08-30 01:54:52.*
