...
**Log Timestamp:** `2026-08-29 16:06:28`  
...
- **National Wholesale**: $P = \$3.384 + (+\$0.000) = \$3.218\text{/gal}$ (Delta: +\$0.000/gal, 0.00\%)
- **Tulsa, OK Retail**: $P = \$3.751 + (+\$0.024) = \$3.632\text{/gal}$ (Delta: +\$0.024/gal, +0.63\%)
- **Newark, DE Retail**: $P = \$3.934 + (+\$0.015) = \$3.792\text{/gal}$ (Delta: +\$0.015/gal, +0.38\%)
- **Cincinnati, OH/KY**: $P = \$3.878 + (+\$0.019) = \$3.750\text{/gal}$ (Delta: +\$0.019/gal, +0.49\%)
- **Greenville, NC Retail**: $P = \$3.874 + (+\$0.017) = \$3.733\text{/gal}$ (Delta: +\$0.017/gal, +0.44\%)
- **Charlotte, NC Retail**: $P = \$3.742 + (+\$0.023) = \$3.612\text{/gal}$ (Delta: +\$0.023/gal, +0.60\%)
- **Oakland, CA Retail**: $P = \$5.667 + (+\$0.187) = \$5.465\text{/gal}$ (Delta: +\$0.187/gal, +3.29\%) *(includes CA statutory CARB excise, Cap-and-Trade & LCFS fee overhead of $0.953/gal)*
- **SF Bay Area Region**: $P = \$5.667 + (+\$0.087) = \$5.465\text{/gal}$ (Delta: +\$0.087/gal, +1.53\%) *(includes CA statutory CARB excise, Cap-and-Trade & LCFS fee overhead of $0.953/gal)*
...
The base commodity forecast was calibrated across all 8 modeled metro locales for this run:
  • National Wholesale: $3.218/gal ($0.000/gal, 0.00%)
  • Tulsa, OK Retail: $3.632/gal (+$0.024/gal, +0.63%)
  • Newark, DE Retail: $3.792/gal (+$0.015/gal, +0.38%)
  • Cincinnati, OH/KY: $3.750/gal (+$0.019/gal, +0.49%)
  • Greenville, NC Retail: $3.733/gal (+$0.017/gal, +0.44%)
  • Charlotte, NC Retail: $3.612/gal (+$0.023/gal, +0.60%)
  • Oakland, CA Retail: $5.465/gal (+$0.187/gal, +3.29%)
  • SF Bay Area Region: $5.465/gal (+$0.087/gal, +1.53%)

Largest upward shift for this run: Oakland, CA Retail at $5.465/gal (+0.187/gal). Largest downward shift for this run: National Wholesale at $3.218/gal (+0.000/gal). California locations (Oakland & SF Bay Area) incorporate statutory $0.953/gal CARB excise, Cap-and-Trade, and LCFS fee overhead on top of the base commodity calibration.

### Forecast Uncertainty & Counterfactual Catalysts
FORECAST UNCERTAINTY & CATALYST SCENARIOS FOR THIS RUN:

Evaluated tail-risk catalysts specific to execution [2026-08-29 16:06:28]:
...
---
*Report generated automatically by Midgley Dashboard Generator Engine at 2026-08-29 16:06:28.*
