...
* **Location:** [`src/pasa_research_agent.py`](file:///src/pasa_research_agent.py) (`PaSaResearchAgent`, `CrawlerAgent`, `SelectorAgent`) & [`src/event_analyzer.py`](file:///src/event_analyzer.py) (`investigate_event_with_pasa`)
