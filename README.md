...
<!-- START_LIVE_FORECAST -->
### 📢 Live 5-Day Price Forecasts (Updated: 2026-08-25 20:10 UTC)
...
| **Tulsa, OK Metro Retail** | `$3.840`/gal | **`$3.750`/gal** | **DOWN 📉** | `2026-08-29` | `v1.4-Finlight-Ridge` |
| **Newark, DE Metro Retail** | `$3.966`/gal | **`$3.859`/gal** | **DOWN 📉** | `2026-08-29` | `v1.4-Finlight-Ridge` |
| **Cincinnati, OH Retail** | `$3.992`/gal | **`$3.906`/gal** | **DOWN 📉** | `2026-08-29` | `v1.4-Finlight-Ridge` |
| **Northern Kentucky Retail** | `$3.661`/gal | **`$3.582`/gal** | **DOWN 📉** | `2026-08-29` | `v1.4-Finlight-Ridge` |
| **Greenville, NC Metro Retail** | `$3.395`/gal | **`$3.302`/gal** | **DOWN 📉** | `2026-08-29` | `v1.4-Finlight-Ridge` |
| **Oakland, CA Metro Retail** | `$5.623`/gal | **`$5.473`/gal** | **DOWN 📉** | `2026-08-29` | `v1.4-Finlight-Ridge` |
| **SF Bay Area 9-County Avg** | `$5.623`/gal | **`$5.473`/gal** | **DOWN 📉** | `2026-08-29` | `v1.4-Finlight-Ridge` |
