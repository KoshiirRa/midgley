...
<!-- START_LIVE_FORECAST -->
### 📢 Live 5-Day Price Forecasts (Updated: 2026-09-21 19:14 UTC)
...
| **Tulsa, OK Metro Retail** | `$3.991`/gal | **`$5.545`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-Tulsa-Ridge` |
| **Newark, DE Metro Retail** | `$4.361`/gal | **`$4.360`/gal** | **DOWN 📉** | `2026-09-25` | `v1.6-Ipatieff-Newark-Ridge` |
| **Cincinnati, OH Retail** | `$4.471`/gal | **`$4.471`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-CincinnatiOH-Ridge` |
| **Northern Kentucky Retail** | `$4.517`/gal | **`$4.517`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-CincinnatiKY-Ridge` |
| **Greenville, NC Metro Retail** | `$4.139`/gal | **`$4.135`/gal** | **DOWN 📉** | `2026-09-25` | `v1.6-Ipatieff-Greenville-Ridge` |
| **Oakland, CA Metro Retail** | `$6.220`/gal | **`$6.223`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-Oakland-Ridge` |
| **SF Bay Area 9-County Avg** | `$6.332`/gal | **`$6.335`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-BayArea-Ridge` |
