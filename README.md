...
<!-- START_LIVE_FORECAST -->
### 📢 Live 5-Day Price Forecasts (Updated: 2026-09-20 13:34 UTC)

| Region / Market | Current Price | 5-Day Forecast | Projected Direction | Target Date | Model Version |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **National Wholesale (RBOB)** | `$3.256`/gal | **`$3.240`/gal** | **DOWN 📉** | `2026-09-25` | `v1.6-Ipatieff-National-Ridge` |
| **Tulsa, OK Metro Retail** | `$4.004`/gal | **`$5.895`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-Tulsa-Ridge` |
| **Newark, DE Metro Retail** | `$4.357`/gal | **`$4.355`/gal** | **DOWN 📉** | `2026-09-25` | `v1.6-Ipatieff-Newark-Ridge` |
| **Cincinnati, OH Retail** | `$4.487`/gal | **`$4.487`/gal** | **DOWN 📉** | `2026-09-25` | `v1.6-Ipatieff-CincinnatiOH-Ridge` |
| **Northern Kentucky Retail** | `$4.523`/gal | **`$4.523`/gal** | **DOWN 📉** | `2026-09-25` | `v1.6-Ipatieff-CincinnatiKY-Ridge` |
| **Greenville, NC Metro Retail** | `$4.146`/gal | **`$4.146`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-Greenville-Ridge` |
| **Oakland, CA Metro Retail** | `$6.206`/gal | **`$6.236`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-Oakland-Ridge` |
| **SF Bay Area 9-County Avg** | `$6.329`/gal | **`$6.359`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-BayArea-Ridge` |
