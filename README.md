...
<!-- START_LIVE_FORECAST -->
### 📢 Live 5-Day Price Forecasts (Updated: 2026-09-21 15:38 UTC)

| Region / Market | Current Price | 5-Day Forecast | Projected Direction | Target Date | Model Version |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **National Wholesale (RBOB)** | `$3.528`/gal | **`$3.507`/gal** | **DOWN 📉** | `2026-09-25` | `v1.6-Ipatieff-National-Ridge` |
| **Tulsa, OK Metro Retail** | `$3.991`/gal | **`$5.482`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-Tulsa-Ridge` |
| **Newark, DE Metro Retail** | `$4.361`/gal | **`$4.362`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-Newark-Ridge` |
| **Cincinnati, OH Retail** | `$4.471`/gal | **`$4.466`/gal** | **DOWN 📉** | `2026-09-25` | `v1.6-Ipatieff-CincinnatiOH-Ridge` |
| **Northern Kentucky Retail** | `$4.517`/gal | **`$4.512`/gal** | **DOWN 📉** | `2026-09-25` | `v1.6-Ipatieff-CincinnatiKY-Ridge` |
| **Greenville, NC Metro Retail** | `$4.139`/gal | **`$4.140`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-Greenville-Ridge` |
| **Oakland, CA Metro Retail** | `$6.220`/gal | **`$6.228`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-Oakland-Ridge` |
| **SF Bay Area 9-County Avg** | `$6.332`/gal | **`$6.340`/gal** | **UP 📈** | `2026-09-25` | `v1.6-Ipatieff-BayArea-Ridge` |
