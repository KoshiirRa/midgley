# LLM-Augmented Unleaded Gas Price Prediction Model (`midgley` v0.4.0)

[![Release: v0.4.0](https://img.shields.io/badge/Release-v0.4.0-orange.svg)](https://github.com/KoshiirRa/midgley/releases/tag/v0.4.0)
