...
<!-- START_LIVE_FORECAST -->
### 📢 Live 5-Day Price Forecasts (Updated: 2026-09-24 13:07 UTC)

| Region / Market | Current Price | 5-Day Forecast | Projected Direction | Target Date | Model Version |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **National Wholesale (RBOB)** | `$3.587`/gal | **`$3.530`/gal** | **DOWN 📉** | `2026-09-30` | `v1.6-Ipatieff-National-Ridge` |
| **Tulsa, OK Metro Retail** | `$3.995`/gal | **`$4.610`/gal** | **UP 📈** | `2026-09-30` | `v1.6-Ipatieff-Tulsa-Ridge` |
| **Newark, DE Metro Retail** | `$4.335`/gal | **`$4.303`/gal** | **DOWN 📉** | `2026-09-30` | `v1.6-Ipatieff-Newark-Ridge` |
| **Cincinnati, OH Retail** | `$4.389`/gal | **`$4.347`/gal** | **DOWN 📉** | `2026-09-30` | `v1.6-Ipatieff-CincinnatiOH-Ridge` |
| **Northern Kentucky Retail** | `$4.460`/gal | **`$4.417`/gal** | **DOWN 📉** | `2026-09-30` | `v1.6-Ipatieff-CincinnatiKY-Ridge` |
| **Greenville, NC Metro Retail** | `$4.129`/gal | **`$4.093`/gal** | **DOWN 📉** | `2026-09-30` | `v1.6-Ipatieff-Greenville-Ridge` |
| **Oakland, CA Metro Retail** | `$6.288`/gal | **`$6.213`/gal** | **DOWN 📉** | `2026-09-30` | `v1.6-Ipatieff-Oakland-Ridge` |
| **SF Bay Area 9-County Avg** | `$6.401`/gal | **`$6.325`/gal** | **DOWN 📉** | `2026-09-30` | `v1.6-Ipatieff-BayArea-Ridge` |
