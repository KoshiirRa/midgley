...
<!-- START_LIVE_FORECAST -->
### 📢 Live 5-Day Price Forecasts (Updated: 2026-09-02 07:02 UTC)

| Region / Market | Current Price | 5-Day Forecast | Projected Direction | Target Date | Model Version |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **National Wholesale (RBOB)** | `$3.135`/gal | **`$3.188`/gal** | **UP 📈** | `2026-09-06` | `v1.4-Finlight-Ridge` |
...
| **Northern Kentucky Retail** | `$3.707`/gal | **`$3.635`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
| **Greenville, NC Metro Retail** | `$3.627`/gal | **`$3.552`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
| **Oakland, CA Metro Retail** | `$5.703`/gal | **`$5.586`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
| **SF Bay Area 9-County Avg** | `$5.703`/gal | **`$5.586`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
