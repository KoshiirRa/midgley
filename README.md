...
<!-- START_LIVE_FORECAST -->
### 📢 Live 5-Day Price Forecasts (Updated: 2026-09-02 12:11 UTC)

| Region / Market | Current Price | 5-Day Forecast | Projected Direction | Target Date | Model Version |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **National Wholesale (RBOB)** | `$3.135`/gal | **`$3.092`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
| **Tulsa, OK Metro Retail** | `$3.694`/gal | **`$3.627`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
| **Newark, DE Metro Retail** | `$3.968`/gal | **`$3.924`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
| **Cincinnati, OH Retail** | `$3.804`/gal | **`$3.758`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
| **Northern Kentucky Retail** | `$3.788`/gal | **`$3.742`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
| **Greenville, NC Metro Retail** | `$3.621`/gal | **`$3.561`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
| **Oakland, CA Metro Retail** | `$5.737`/gal | **`$5.675`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
| **SF Bay Area 9-County Avg** | `$5.737`/gal | **`$5.675`/gal** | **DOWN 📉** | `2026-09-06` | `v1.4-Finlight-Ridge` |
