...
### 111. Regional ULSD Distillate Engine Simulation Segregation (`src/diesel_regional.py` - Issue #463)
- **Explicit Simulation Tagging:** Labeled regional ULSD distillate forecasts with `status: "EXPERIMENTAL_SIMULATION"` and `is_simulation: True`.
- **Documented Experimental Status:** Clearly demarcated the diesel engine as an experimental simulation component pending full live ground truth calibration across all metro hubs.
